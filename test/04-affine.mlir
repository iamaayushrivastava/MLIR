      ...
      affine.for %arg4 = 0 to 300 {
        affine.for %arg5 = 0 to 400 {
          affine.for %arg6 = 0 to 400 {
            affine.for %arg7 = 0 to 300 {
              %0 = affine.load %arg0[%arg3, %arg5] : memref<?x400xf32>
              %1 = affine.load %arg1[%arg5, %arg6] : memref<?x300xf32>
              %2 = arith.mulf %0, %1 : f32
              %3 = affine.load %arg0[%arg6, %arg7] : memref<?x400xf32>
              %4 = arith.mulf %2, %3 : f32
              %5 = affine.load %arg1[%arg7, %arg4] : memref<?x300xf32>
              %6 = arith.mulf %4, %5 : f32
              %7 = affine.load %arg2[%arg3, %arg4] : memref<?x300xf32>
              %8 = arith.addf %7, %6 : f32
              affine.store %8, %arg2[%arg3, %arg4] : memref<?x300xf32>
            }
          }
        }
      }
